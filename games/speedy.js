...
SpeedyContainer.prototype = Object.create(GameContainer.prototype);

SpeedyContainer.prototype.endSpeedyGame = function () {
...
SpeedyContainer.prototype._checkIntersection = function (a, b) {
  var ab = a.getBounds();
  var bb = b.getBounds();
  return (
    ab.x + ab.width > bb.x &&
...
SpeedyContainer.prototype._drawEndMenu = function () {
...
SpeedyContainer.prototype._createBackground = function () {
...
SpeedyContainer.prototype._addScore = function () {
...
SpeedyContainer.prototype._createKeyboardInput = function () {
...
SpeedyContainer.prototype._createShapesBg = function () {
...
SpeedyContainer.prototype._createShape = function (
  shapeValue,
  x,
  y,
  width,
...
SpeedyContainer.prototype._createNextShapes = function () {
...
SpeedyContainer.prototype._createTriangle = function (
  xPos,
  yPos,
  width,
  color
...
SpeedyContainer.prototype.startGame = function () {
  this._createKeyboardInput();
  this._createNextShapes();
  this._createTimeTicking(this.endSpeedyGame.bind(this));
};

SpeedyContainer.prototype._initialize = function () {
